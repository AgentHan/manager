...
public partial class pxinfoadd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(s);
        con.Open();
        string sqlcon = "insert into pxxx(pxsj,pxmc,pxqc,bengintime,endtime,pxcost,pxnr) values('" + TxtPxtime.Text + "','" + TxtPxmc.Text + "','" + TxtPxqc.Text + "','" + TxtPxbegin.Text + "','" + TxtPxend.Text + "','" + TxtPxcost.Text + "','" + TxtPxnr.Text + "')";
