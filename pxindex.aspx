                ...
                <asp:TreeView ID="TreeView1" runat="server" Height="503px" ImageSet="Contacts" NodeIndent="10" OnLoad="TreeView1_Load" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged" Width="139px">
                    ...
                    <Nodes>
                        <asp:TreeNode Text="培训项目" Value="领导培训人员财务人员管理员系部学员">
                            ...
                            <asp:TreeNode Expanded="False" NavigateUrl="~/xybm.aspx" Text="学员报名" Value="领导培训人员财务人员管理员系部学员"></asp:TreeNode>
                            <asp:TreeNode Text="学员分班" Value="培训人员管理员" NavigateUrl="~/no.aspx"></asp:TreeNode>
                            <asp:TreeNode NavigateUrl="~/pxpay.aspx" Target="ICount" Text="培训缴费" Value="领导财务人员管理员"></asp:TreeNode>
                            <asp:TreeNode NavigateUrl="~/pxcost.aspx" Target="ICount" Text="支出费用登记" Value="财务人员领导管理员"></asp:TreeNode>
                            <asp:TreeNode NavigateUrl="~/search.aspx" Target="ICount" Text="收入支出统计" Value="领导管理员"></asp:TreeNode>
                        </asp:TreeNode>
